  ...
  return (
    <div className="flex w-11/12 flex-col gap-y-4">
      ...
      <div>
        <div
          className={twMerge(
            "flex w-11/12 flex-col rounded-base border-2 border-secondaryBlack p-4 py-2 shadow-light md:w-10/12 lg:w-full",
          ...
          <div className="flex flex-col justify-between gap-x-2">
            <div className="my-4 flex w-full gap-2 max-lg:flex-col max-md:flex-col lg:flex-row-reverse">
              ...
              <button
                ...
                className="cta-button flex items-center justify-center gap-x-2 rounded-base bg-red-200 p-4 text-lg font-bold underline disabled:font-normal disabled:no-underline max-lg:w-full md:mr-auto"
              >
                <span
